...
class ClusterNlp:
    ...
    def cluster_similarity(self, cluster_id: str, new_article_id: str) -> float:
        ...
        sim_rate = self.nlp.compare_texts(main_article.article_content,new_article.content)
    ...
    def _check_avg_cluster_sim(self, article_ids: list[str], new_article: Article) -> float:
        ...
        for article in articles:
            avg_rate = avg_rate + self.nlp.compare_texts(new_article,article.content)#self.nlp._transformers_similarity([new_article, article.content])
